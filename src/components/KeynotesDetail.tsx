...
const cards = [
  { img: a, title: "Tech Trends 2026", desc: "Tendencias tecnológicas y su impacto futuro en LATAM." },
  { img: b, title: "Skills de Liderazgo", desc: "Lo que diferencia a los líderes en tech y en startups en hipercrecimiento." },
  { img: c, title: "Revolución IA", desc: "Cómo la IA redefine industrias globalmente y a quién toma por sorpresa." },
];
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {cards.map((card, i) => (
            <motion.article
              ...
              className="group overflow-hidden rounded-[16px] border border-white/5 bg-white/[0.02]"
            >
